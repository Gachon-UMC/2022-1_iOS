...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        bulletText2.attributedText = bulletPointList(strings: ["✨유데미 강의를 들으며 워크북을 작성!","🔥 저희는 Challenged Based Learning 학습을 해요. 매주 실습 과제로 단순 이론 보다는 직접 부딪치며 야생학습(?)을 합니다!", "💻 매주 서로의 코드를 리뷰하는 문화를 가지고 있습니다!"])
